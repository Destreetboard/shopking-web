...
const PrivacyPolicy: React.FC<PrivacyPolicyProps> = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy - Shopking, Shopping Errand Serices</title>
      </Head>
      ...
      <div className="page-content">
        <div className="row section container">
          <div className="col-6">
            ...
            information is collected, used, stored, and disclosed by Shopking,
            ("Shopking," "we," "us," and "our"). The provisions contained in
        ...
        <div className="section container">
          <p>
            {`At Shopking.ng, accessible from www.shopking.ng,
             one of our main priorities is the privacy of our visitors.
             This Privacy Policy document contains types of information that is
              collected and recorded by Shopking.ng and how we use it. If you have
              ...
              collect in Shopking.ng. This policy is not applicable to any
        ...
        <div className="section container">
          ...
          provide your personal information. If you contact us directly, we may
        ...
        <div className="container section">
          <h1 className="mb-1">Log Files</h1>
          <p>
            <span className="text--bold">Shopking.ng</span> follows a standard
          ...
          <p>
            <p className="text--bold">Cookies and Web Beacons</p>
            Like any other website, Shopking.ng uses ‘cookies’. These cookies
          ...
          <p>
            <p className="text--bold">Advertising Partners Privacy Policies</p>
            You may consult this list to find the Privacy Policy for each of the
            advertising partners of Shopking.ng. Third-party ad servers or ad
            ...
            appear on Shopking.ng, which are sent directly to users’ browser.
            ...
            that you see on websites that you visit. Note that Shopking.ng has
            no access to or control over these cookies that are used by
            third-party advertisers.
          </p>
          <p>
            <p className="text--bold">Third Party Privacy Policies</p>
            Shopking’s Privacy Policy does not apply to other advertisers or
          ...
          <p>
            <p className="text--bold">CCPA Privacy</p>
          ...
          <p>
            <p className="text--bold">GDPR Data Protection Rights</p>
          ...
          <p>
            <span className="text--bold">Shopking.ng </span> does not knowingly
