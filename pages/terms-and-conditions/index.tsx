      ...
      <div className="page-content">
        ...
        <div className="section container">
          <p>
            ...
            use of Shopking’s Website, located at www.shopking.ng. By accessing
            this website we assume you accept these terms and conditions. Do not
            continue to use Shopking.ng if you do not agree to take all of the
        ...
        <div className="section container">
          <h1 className="mb-1">Cookies</h1>
          <p>
            We employ the use of cookies. By accessing Shopking.ng, you agreed
            to use cookies in agreement with the Shopking’s Privacy Policy. Most
        ...
        <div className="section container">
          ...
          <p className="mb-1">
            Unless otherwise stated, Shopking.ng and/or its licensors own the
            intellectual property rights for all material on Shopking.ng. All
            intellectual property rights are reserved. You may access this from
            Shopking.ng for your own personal use subjected to restrictions set
            in these terms and conditions. You most not:
          </p>
          <ul className="mb-1">
            <li>Republish material from Shopking.ng</li>
            <li>Sell, rent or sub-license material from Shopking.ng</li>
            <li>Reproduce, duplicate or copy material from Shopking.ng</li>
            <li>Redistribute content from Shopking.ng</li>
          </ul>
          ...
          <p>
            For any parts of the website that give users the ability to
            independently create content, whether in existence now or in the
            future. Parts of this website offer an opportunity for users to post
            and exchange opinions and information in certain areas of the
            website. Shopking.ng does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of Shopking.ng, its agents and/or
            ...
            applicable laws, Shopking.ng shall not be liable for the Comments or
          ...
          <p>
            <span className="text--bold">Shopking.ng</span> reserves the right
          ...
          <p className="text--bold mb-1">You warrant and represent that:</p>
          <ul className="mb-1">
            <li>
            ...
            <li>
              You hereby grant Shopking.ng a non-exclusive license to use,
              reproduce, edit and authorize others to use, reproduce and edit
              any of your Comments in any and all forms, formats or media.{" "}
            </li>
          </ul>

          <p className="text--bold">Hyperlinking to our Content</p>
          <p>
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Shopking.ng;
            ...
            must inform us by sending an e-mail to Shopking.ng. Please include
          ...
          <p>
            ...
            No use of Shopking’s logo or other artwork will be allowed for
            linking absent a trademark license agreement.
          </p>

          <p className="text--bold">iFrames</p>
          <p>
          ...
          <p className="text--bold">Content Liability</p>
          <p>
          ...
          <p className="text--bold">Your Privacy</p>
          <p>
            Please read <Link href="/privacy-policy">Privacy Policy</Link>
          </p>

          <p className="text--bold">Reservation of Rights</p>
          <p>
          ...
          <p className="text--bold">Removal of links from our</p>
          <p>
